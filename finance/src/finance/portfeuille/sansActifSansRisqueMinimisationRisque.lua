...
-- obligation in fine
SansActifSansRisqueMinimisationDeRisque = Tmv(MATRICE_VAR_COVAR_ID,MATRICE_VAR_COVAR_HEADER_ID)
...
-- correlation
   ...
   Portefeuillef.sansActifSansRisqueMinimisationDeRisque(self)
