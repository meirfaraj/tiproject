...
-- nothing to be done in "nb jour/jour"
   if varValue["ptype"] == "exact/exact" then
      TauxSimplef.calct_exactExact(self,varValue["C"],r,self.Nj,self.Na)
      return
   end
   if varValue["ptype"] == "exact/360" then
      TauxSimplef.calct_exact360(self,varValue["C"],r,self.Nj,self.Na)
      return   
   end
   if varValue["ptype"] == "30/360" then
      TauxSimplef.calct_30360(self,varValue["C"],r,self.Nj,self.Na)
      return   
   end
   TauxSimplef.calct(self,varValue["C"],r,self.Nj,self.Na)
end
