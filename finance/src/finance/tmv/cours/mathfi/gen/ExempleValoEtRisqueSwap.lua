...
function ExempleValoEtRisqueSwap:performCalc()
  ...
  self:appendMathToResult(" Cn=100000*5.5%*(182/360)=2780.5 ")
  self:appendToResult(" donc V(Ar) = 100000+Cn=102780.5\n")
  self:appendToResult("")
  self:appendMathToResult(" V(Ak)=100000 * (1.06)^(0.5) * (( "..sum_sym.."((0.05/1.06^t))+100*1/1.06^4) = 99388.8 ,t,1,4)")
  self:appendToResult(" \n")
  self:appendToResult("Donc ")
  self:appendMathToResult("V(S(k-r))=-3391.7")
  self:appendToResult(" \n ")
  self:appendToResult("\n")
  ...
  self:appendToResult("")
  self:appendMathToResult(" V(Ak)=100000 * (( "..sum_sym.."((0.05/1.055^t))+ 1/1.055^3) = 98651.033 ,t,1,3)")
  self:appendToResult(" \n ")
  self:appendToResult("Donc V(S(k-r))=-1348.966 \n ")
  self:appendToResult("Méthode équivalence: ")
  self:appendMathToResult(" V(S(k-r))=100000 (5%-5.5%) * ( "..sum_sym.."((1/1.055^t)) = -1348.966 ,t,1,3)")
  self:appendToResult(" \n ")
  self:appendToResult("\n")
