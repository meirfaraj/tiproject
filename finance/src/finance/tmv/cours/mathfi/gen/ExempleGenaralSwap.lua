...
function ExempleGenaralSwap:performCalc()
  ...
  self:appendToResult(" Un an plus tard 1/1/n+1(donc le Swap lui reste 3 ans), la gamme des taux fixe swap(k("..c_theta..")) évolue\n")
  ...
  self:appendToResult("\n")
  self:appendToResult("a)calcul des prix b("..c_theta..") et des ZC à partier de k("..c_theta..")")
  self:appendToResult("\n")
  self:appendToResult("")
