...
function InstrumentsVanillesTauxFlottant:performCalc()
  self:appendToResult("")
  self:appendTitleToResult("Instrument Vanille "..a_grave.." taux flottant")
  ...
  self:appendToResult("i- ")
  self:appendMathToResult(" V(31/3/n) = 100K+Cn=100K + 100K*0.04*182/360=102022")
  self:appendToResult(" n")
  self:appendToResult(" ")
  self:appendMathToResult("V(1/4/n) = 100K")
  self:appendToResult(" titre au pair n")
  self:appendToResult(" "..a_grave.." 3 mois du r"..e_grave.."glement 30/12/n-1 L3-mois=5%, ")
  self:appendMathToResult("V(30/12/n-1)=102022/(1+L*D)=102022/(1 + 0.05*90/360)=100762")
  self:appendToResult(" n")
  self:appendToResult("ii-variation du titre et la perte de valeur induite par la hausse L3de 0.2% le 30/12/n-1 n")
  self:appendToResult("")
  self:appendMathToResult("V(r)=F/(1+rD)")
  self:appendToResult(", ")
  self:appendMathToResult("dV/dr=-FD/(1+rD)^2")
  self:appendToResult("; le 30/12/n-1 r=E3=5%, D=0.25, V(r)=100762 n")
  self:appendToResult("donc ")
  self:appendMathToResult(" dV/dr=-102762*0.25/(1+0.05*0.25)^2=-24880")
  self:appendToResult(" donc 0.2% de hausse taux court entraine baisse de ")
  ...
  self:appendToResult("Cn=Produit(1+D*E3) - 1 avec D=Nj/360, coupon vers"..e_acute.." le 1/10 n")
  ...
  self:appendToResult("et le 1/2/n donc "..a_grave.." 59j du prochain reset E2=4% n")
  self:appendToResult("")
  self:appendMathToResult("V(t)=F/(1+D*r(t))")
  self:appendToResult(", ")
  self:appendMathToResult("dV/dr=-F*D/(1+r*D)^2")
  self:appendToResult(" n")
  self:appendToResult("i- 1/10/n-1: apr"..e_grave.."s le coupon et instrument au pair V=50000 n")
  self:appendToResult("1/1/n: V=50000(1+0.04*92/360)=50511.111 n")
  self:appendToResult("1/4/n: il faut capitalis"..e_acute.." V=50511.111(1+0.036*90/360)=50965.711 n")
  self:appendToResult("1/2/n: V=50965.711/(1+59/360*0.04)=50633.778 n")
  self:appendToResult("ii- variations pour hausse des taux de 0.1% n")
  self:appendToResult("2/1/n: ")
  self:appendMathToResult("dV=-dr*50965.711*(89/360)/(1+(89/360)*0.036)^2=-dr*12378 ")
  self:appendToResult(" n")
  self:appendToResult("31/3/n: ")
  self:appendMathToResult("dV=-dr*50965.711*(1/360)/(1+(1/360)*0.036)^2=-dr*141 ")
  self:appendToResult(" n")
  self:appendToResult("1/2/n: ")
