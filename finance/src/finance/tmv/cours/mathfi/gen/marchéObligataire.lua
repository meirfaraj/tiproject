...
--------------------------------------------------------------------------
  ...
  self:appendToResult(" donc c'est la duration diviser par 1+r <br>")
  self:appendToResult("")
  ...
  self:appendToResult(" <br>")
  self:appendToResult("<u>Exemple: valorisation et risue rente perp"..e_acute.."tuelle </u><br>")
  ...
  self:appendToResult("actuariel continu) est r et de le taux de coupon est k (elle distribue un coupon annuel k "..a_grave.." l?infini) <br>")
  self:appendToResult("On se situe "..a_grave.." une date quelconque entre deux coupons, t ann"..e_acute.."es apr"..e_grave.."s le pr"..e_acute.."c"..e_acute.."dent d"..e_acute.."tachement et (o"..u_grave.." t est compris entre 0 et 1) <br>")
  self:appendToResult("Le taux discret est ")
  self:appendMathToResult("r = exp(rc) - 1")
  self:appendToResult(" <br>")
  self:appendToResult("")
  self:appendMathToResult("V = (1+r)^t * ( Somme{t=1 -> infini}(k/(1+r)^t))= (k/r) * (1+r)^t")
  self:appendToResult(" <br>")
  self:appendToResult("<u>Exemple: taux continus montrer que S=D </u> <br>")
  self:appendToResult("")
  ...
  self:appendToResult(" <br>")
  self:appendToResult("d"..e_acute.."veloppement "..a_grave.." l'ordre 2 donne <br>")
  self:appendToResult("")
  ...
  self:appendToResult("<br><br>")
  self:appendToResult("Exemple : ")
  self:appendToResult("obligation 10 ans "..a_grave.." courir, de 100?, k=6%,r=5% <br>")
  self:appendToResult("")
  self:appendMathToResult("V=Somme[t=1->9](6/1.05^t)+106/(1.05)^10=107.72")
  self:appendToResult("? <br>")
  ...
  self:appendToResult(" ans <br>")
  self:appendToResult("hausse de taux de 1% traduit approximativement, par une baisse de valeur de titre de 7.52% <br>")
  self:appendToResult("<u>Exemple </u>: <br>")
  self:appendToResult("obligation 10 ans, venant de d"..e_acute.."tacher un coupon 5%,")
  self:appendToResult("")
  self:appendMathToResult("r=5% ")
  self:appendToResult("donc obligation actuellement au pair <br>")
  self:appendToResult("")
  self:appendMathToResult("V(5%)=Somme[t=1->10](5/1.05^t)+100/(1.05)^10=100")
  self:appendToResult("? <br>")
  self:appendToResult("pour ")
  self:appendMathToResult("r=5.1% V(5,1%)=Somme[t=1->10](5/1.051^t)+100/(1.051)^10=99.23")
  self:appendToResult("? <br>")
  self:appendToResult("Sa sensibilit"..e_acute.." ")
  ...
  self:appendToResult("<br>")
  self:appendToResult("<u>Exemple<u>: rente perp"..e_acute.."tuelle avec r et k")
  self:appendToResult("")
